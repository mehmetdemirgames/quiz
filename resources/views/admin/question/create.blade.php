<x-app-layout>
    <x-slot name="header">{{  $quiz->title }} Quiz'i için soru oluştur</x-slot>
            ...
            <form action="{{route('questions.store', $quiz->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>1.Cevap</label>
                            <input type="text" name="answer1" class="form-control" value="{{ old('answer1')}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>2.Cevap</label>
                            <input type="text" name="answer2" class="form-control" value="{{ old('answer2')}}">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>3.Cevap</label>
                            <input type="text" name="answer3" class="form-control" value="{{ old('answer3')}}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>4.Cevap</label>
                            <input type="text" name="answer4" class="form-control" value="{{ old('answer4')}}">
                        </div>
                    </div>
                </div>
